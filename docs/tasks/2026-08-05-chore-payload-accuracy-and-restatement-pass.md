...
- [x] Rule inventories extracted for all five files needing them: `CLAUDE.md` (164 rules), the skills README (365), `implement-task` (143), `review-board` (117), `fork-points` (60). Ready for the user's cull. The nine trim files need no inventory, since splitting a run-on drops nothing.
